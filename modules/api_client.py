...
if __name__ == "__main__":
    # 급여 정보 테스트
    feeding_data = {"amount": 20}
    response_feeding = send_sensor_data("SN123456", "feeding", feeding_data, "2025-02-19T12:34:56Z")
    print("Feeding Response:", response_feeding)
    ...
    response_eye = send_sensor_data("SN123456", "eye", eye_data, "2025-02-19T12:34:56Z")
    print("Eye Response:", response_eye)
